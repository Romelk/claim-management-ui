...
const OrderedActions = () => {
  ...
  const PriorityIndicator = ({ priority }: { priority: string }) => {
    const color = priority === 'High' ? '#d32f2f' : priority === 'Medium' ? '#f57c00' : '#4caf50';
    ...
    <>
      ...
      >
        ...
        <Box sx={{ display: 'flex', gap: 1 }}>
          ...
          <Button variant="contained" startIcon={<AddIcon />} size="small" color="primary">
            Add Action
          </Button>
        </Box>
      </Box>
      ...
      {filterOpen && (
        ...
        >
          <TextField select label="Status" size="small" sx={{ width: 150 }} defaultValue="">
          ...
          <TextField select label="Priority" size="small" sx={{ width: 150 }} defaultValue="">
            <MenuItem value="">All</MenuItem>
          ...
          <TextField select label="Type" size="small" sx={{ width: 150 }} defaultValue="">
            <MenuItem value="">All</MenuItem>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <FormControlLabel control={<Switch size="small" />} label="Show completed" />
          </Box>
              ...
              >
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 3, mb: 2 }}>
                  <Box>
                    ...
                    <Typography variant="body2">{action.assignedTo}</Typography>
                  </Box>
                  ...
                  <Box>
                    ...
                    <Typography variant="body2">{action.dueDate}</Typography>
                  </Box>
                  ...
                  <Box>
                    ...
                    <Typography variant="body2">{action.priority}</Typography>
                  </Box>
                  ...
                  <Box>
                    ...
                    <Typography variant="body2">{action.status}</Typography>
                  </Box>
                </Box>
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  <Typography variant="body2">{action.notes}</Typography>
                </Box>
